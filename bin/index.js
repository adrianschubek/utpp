...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __nccwpck_require__(913);
	}
...
const ansiStyles = __nccwpck_require__(57);
const {stdout: stdoutColor, stderr: stderrColor} = __nccwpck_require__(853);
const {
	stringReplaceAll,
...
const chalkTag = (chalk, ...strings) => {
	...
	if (template === undefined) {
		template = __nccwpck_require__(34);
	}
...
const cssKeywords = __nccwpck_require__(618);
...
const conversions = __nccwpck_require__(255);
const route = __nccwpck_require__(367);
...
const stripAnsi = __nccwpck_require__(203);
const isFullwidthCodePoint = __nccwpck_require__(609);
const emojiRegex = __nccwpck_require__(489);
...
const ansiRegex = __nccwpck_require__(287);
...
const hasFlag = __nccwpck_require__(160);
...
const stringWidth = __nccwpck_require__(526);
const stripAnsi = __nccwpck_require__(203);
const ansiStyles = __nccwpck_require__(57);
...
const yargs_1 = __importDefault(__nccwpck_require__(437));
const helpers_1 = __nccwpck_require__(65);
const chalk_1 = __importDefault(__nccwpck_require__(199));
...
const {applyExtends, cjsPlatformShim, Parser, Yargs, processArgv} = __nccwpck_require__(962)
...
const stringWidth = __nccwpck_require__(526);
const stripAnsi = __nccwpck_require__(203);
const wrap = __nccwpck_require__(983);
function ui(opts) {
    return cliui(opts, {
        stringWidth,
        stripAnsi,
...
/******/ 	var __webpack_exports__ = __nccwpck_require__(__nccwpck_require__.s = 642);
